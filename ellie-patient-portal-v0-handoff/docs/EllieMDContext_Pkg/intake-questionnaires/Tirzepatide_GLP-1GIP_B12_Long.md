...
- Format: Text Box
- Answers: Lbs
- **Conditions: If BMI < 20, DISQUALIFIED**
- Notes: Patient Profile
Height/Weight


## Please enter your blood pressure reading within the last 6 months (Ex: 120/80)
...
**Q4.0** What is the primary reason for seeking GLP-1/GIP+B12 Longevity Microdose therapy?
- Format: Check Box 
(Multi Select) 
- Answers:  ☐ Metabolic Optimization
 ☐ Weight Management for Longevity
 ☐ Cardiovascular Health
 ☐ Appetite Regulation and Dietary Control
 ☐ Inflammation and Cellular Health
 ☐ Longevity and Age-Related Disease Prevention
 ☐ Cognitive and Neurological Health
 ☐ Blood Sugar Control for Non-Diabetic Individual

**Q5.0** Have you experienced any specific symptoms of aging, such as weight gain, decreased energy levels, or changes in metabolism, that you believe GLP-1/GIP medication could help with?
- Format: Radio Button
- Answers: Yes 
No

**Q6.0** Are you aware that microdosing GLP-1/GIP+B12 for longevity is an off-label use, and the scientific research on its long-term benefits for anti-aging is still in early stages?
- Format: Radio Button
- Answers: Yes - I understand that Microdosing GLP-1/GIP+B12 for longevity is off-label use, and the scientific research on its long-term benefits for anti-aging is still in early stages, and I consent to proceed with this treatment. 

No - I do not consent
- **Conditions: If #6 = No, DISQUALIFIED**
- Popup: Since you have chosen not to consent to off-label use of GLP-1/GIP+B12 for longevity and do not wish to proceed with this treatment, we will not move forward with it. If you are interested, we can discuss alternative therapies or approaches that better align with your preferences and goals. Your hea

**Q7.0** Have you discussed GLP-1/GIP+B12 Longevity Microdose Treatment options with your primary care doctor?
- Format: Radio Button
- Answers: Yes 
No
- **Conditions: If Yes or No, Show Pop Up Text**
- Popup: We encourage you to discuss GLP-1/GIP+B12 Longevity Microdose treatment with your primary care provider, as they have a more complete understanding of your health history. EllieMD provides this service based on the information you share and does not replace in-person medical care or long-term health

**Q8.0** Are you currently taking any prescription medications/therapies, or over-the-counter drugs?
- Format: Radio Button
- Answers: Yes
No

**Q8.1** Please specify which prescription medications/therapies, or over-the-counter drugs you are taking, the dosage, and frequency:
...
**Q9.0** Do you have any know allergies to benzyl alcohol?
- Format: Radio Button
- Answers: Yes
No
- **Conditions: If # = Yes, DISQUALIFIED**
...
Do you have any know allergie to vitamin B12 or cobalt?
- Format: Radio Button
- Answers: Yes
No
- **Conditions: If # = Yes, DISQUALIFIED**
- Popup: Unfortunately, we cannot proceed with prescribing this medication if you have a known allergy to vitamin B12 or cobalt. We recommend consulting your primary care provider to explore alternative therapies and options.

**Q10.0** Do you have any known allergies or had any adverse reactions to peptides, medications, or supplements that your medical provider should know about?
- Format: Radio Button
- Answers: Yes
No

**Q10.1** Please specify which medications or supplements you are allergic to:
- Format: Text Box
- **Conditions: If #15 = Yes, DISPLAY**
- Notes: Patient Profile 
Allergies

**Q11.0** Do you have any other allergies that your provider should be aware of?
- Format: Radio Button
- Answers: Yes 
No
...
Do you currently have an active/uncontrolled autoimmune disorder (e.g., lupus, MS, RA, or other)?
- Format: Check Box 
(Multi Select)
- Answers: Yes 
No
- **Conditions: If Yes, Display Information Pop-up**
- Popup: Unfortunately, we cannot proceed with prescribing NAD+ if you have an active or uncontrolled autoimmune disorder. We recommend discussing NAD+ therapy and alternative treatment options with your healthcare provider to ensure the best care for your specific needs.

**Q12.0** Have you ever been diagnosed with any chronic medical conditions? (e.g., diabetes, hypertension, cardiovascular disease, autoimmune disorders)
- Format: Radio Button
- Answers: Yes 
No

**Q12.1** Please state all current diagnosed medical conditions:
- Format: Text Box
...
**Q14.0** Have you had any of the following surgeries?
- Format: Check Box 
(Multi Select) 
