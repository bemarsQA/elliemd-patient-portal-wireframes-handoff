# Weight Management Oral Reassess

Source: 3.0_EllieMD_Questionnaire_Source_of_Truth.xlsx

**Q1.0** Do you wish to continue your treatment with prescription medication for weight management?
- Format: Radio Button
- Answers: If No, DISQUALIFIED
- **Conditions: Yes 
No**
- Popup: Oops! You’ve landed in the wrong place. This intake is only for patients interested in prescription medication for weight management.
[Go Back]  [Explore Microdose Options]


**Q2.0** Since your last intake, are there any changes related to pregnancy? (Ex: Are you currently pregnant, planning to become pregnant, or breast feeding? If male, please select N/A)
- Format: Radio Button
- Answers: If Yes, DISQUALIFIED
- **Conditions: Yes 
No
N/A**
...
**Q4.0** Please enter your current weight:
- Format: Text Box
- **Conditions: Lbs**
- Notes: Patient Profile

**Q5.0** Please update us on your goal weight:
- Format: Text Box
- **Conditions: Goal weight (lbs)**
- Notes: loc::ghk-cu-injection-initial-intake-7

**Q5.1** Based on the height and weight you provided, your current BMI is: [CALCULATED BMI GOES HERE]
- Answers: If BMI => 22, Continue
...
**Q6.0** Do you have any new changes/additions to your medical history?
- Format: Check Box 
(Multi Select) 
- **Conditions:  ☐ New Medications, Therapies, or Over-the-Counter Drugs
 ☐ I am no longer taking a previous medication
  Allergies
...
- Answers: If #6 ="New Medications, Therapies, or Over-the-Counter Drugs", DISPLAY
- **Conditions: Medication Name
Dosage
Frequency**
- Notes: Location: Patient Profile

Field: "patientMedications"
...
**Q6.2** Please list out your allergies:
- Format: Text Box
- Answers: If #6 = "Allergies", DISPLAY

**Q6.3** Please explain:
- Format: Text Box
- Answers: If #6 ="ER Visits or Hospitalizations, Surgeries", DISPLAY

**Q6.4** Please explain:
- Format: Text Box
- Answers: If #6 ="Other", DISPLAY

**Q7.0** Have you had any of the following?
- Format: Check Box 
(Multi Select) 
- **Conditions:  ☐ Gallbladder Removal
...
**Q7.1** Please provide specific details:
- Format: Text Box
- Answers: If #7 = "Gallbladder Removal, Bariatric surgery in the last 6 months (Ex: Gastric Bypass, Gastric Sleeve), Appendix Removal, Uterine Surgery, or Hysterectomy, Breast Surgery, or Mastectomy, Ablation", DISPLAY
- Notes: loc::ghk-cu-injection-initial-intake-2

**Q8.0** Over the past 4 weeks, approximately how many pounds have you lost?
- Format: Radio Button
- **Conditions: 0-3 Pounds
4-6 Pounds
7-12 Pounds
13-20 Pounds
More than 20 pounds
I'm gaining weight **
- Notes: loc::ghk-cu-injection-initial-intake-1

**Q8.1** You're having a significant amount of weight loss:
Please describe in detail other things you are doing to lose weight. Please detail extensively what your diet has been within the last 72 hours. Be very precise.
- Format: Text Box
- Answers: If # 8 = "13-20 Pounds" or 
"More than 20 pounds" , DISPLAY
- **Conditions: Ex: Eating very few calories. Perhaps ___ Calories a day. Over the last 72 hours, I have eaten... **

**Q8.2** Still gaining or maintaining weight?
It is very common for people who are just starting the medication to have little to no weight loss for the first few months. What other things have you done other than take medication?
- Format: Check Box 
(Multi Select) 
- Answers: If #8 = "0-3 punds",  "I'm gaining weight", DISPLAY
- **Conditions:  ☐ See Dietitian
 ☐ Decrease calorie intake 
 ☐ Started an exercise program
 ☐ Attempted to decrease stress
 ☐ None of the above **

**Q9.0** Are you experiencing any food cravings?
- Format: Radio Button
- **Conditions: Not Really
Sometimes
Quite often**

**Q10.0** Are you having appetite suppression?
- Format: Radio Button
- **Conditions: Yes, just where I want to be
Somewhat decreased appetite
Way too much appetite suppression! I can't eat anything. 
I am always hungry!**

**Q11.0** During your treatment, have you experienced fatigue?
- Format: Radio Button
- **Conditions: Yes 
No**

**Q12.0** During your treatment have you experienced decreased muscle mass?
- Format: Radio Button
- **Conditions: Yes 
No**

**Q13.0** During your treatment have you experienced nausea?
- Format: Radio Button
- **Conditions: Yes 
No**

**Q14.0** If you’ve noticed any of the following common side effects, please select all that apply. You’ll receive helpful tips for each one you choose.
- Format: Check Box 
(Multi Select) 
- **Conditions:  ☐ Tell me more about NAUSEA 
 ☐ Tell me more about CONSTIPATION
 ☐ Tell me more about INDIGESTION/REFLUX
 ☐ Not at this time**

**Q14.1** Nausea is the MOST common side effect of taking a GLP-1 medication. Make sure you're doing all the following:
...
- Format: Radio Button
- Answers: If #14 = Tell me more about NAUSEA, DISPLAY
- **Conditions: I've read and understand the above**
...
- Format: Radio Button
- Answers: If #14 = Tell me more about CONSTIPATION, DISPLAY
- **Conditions: I've read and understand the above**

**Q14.3** Heartburn/"Reflux" can be very common while taking GLP-1 medication. If you do not know what heartburn is, or think something else may be wrong, please go to your PCP or nearest urgent care.
...
- Format: Radio Button
- Answers: If #14 = Tell me more about INDIGESTION/REFLUX, DISPLAY
- **Conditions: I've read and understand the above**

**Q15.0** The following are less common side effects. Please select any that you have experienced or are concerned about.
- Format: Check Box 
(Multi Select) 
- **Conditions:  ☐ I am having side effects, but I can handle them
...
**Q15.1** Please make sure to let your doctor and your PCP know if:
- Your symptoms persist
- Your symptoms worsen
- Your symptoms concern you
- Format: Radio Button
- Answers: If #15 = "I am having side effects, but".., DISPLAY
- **Conditions: I acknowledge the above**

**Q15.2** Vomiting while taking GLP-1 medication:
...
- Format: Radio Button
- Answers: If #15 = Significant vomiting, DISPLAY
- **Conditions: I acknowledge the above**

**Q15.3** Abdominal pain while taking a GLP-1 medication:
...
- Format: Radio Button
- Answers: If #15 = Abdominal pain, DISPLAY
- **Conditions: I acknowledge the above**

**Q15.4** Dizziness while taking GLP-1 medication:
...
- Format: Radio Button
- Answers: If #15 = Dizziness, DISPLAY
- **Conditions: I acknowledge the above**

**Q15.5** Chest pain while taking GLP-1 medication:
...
- Format: Radio Button
- Answers: If #15 = Chest pain, DISPLAY
- **Conditions: I acknowledge the above**

**Q15.6** Fever while taking GLP-1 medication:
...
- Format: Radio Button
- Answers: If #15 = Fever, DISPLAY
- **Conditions: I acknowledge the above**

**Q15.7** Swelling in the neck while taking any GLP-1 medication:
...
- Format: Radio Button
- Answers: If #15 = Swelling in the neck, DISPLAY
- **Conditions: I acknowledge the above**

**Q15.8** Please tell the doctor all about the symptoms you are experiencing:
...
- Format: Text Box
- Answers: If #15 = Other, DISPLAY
- **Conditions: Type your answer...**

**Q16.0** Lets start by gathering some information from your previous medication & dosing:

**Q16.1** Please upload a photo of your last prescription so that medication directions, dose, and strength are visible.
- Format: Photo Upload
- Answers: If #9 = orange or red questions, DISPLAY
...
**Q17.0** Please fill out the following:
...
**Q16.0** Would you like to continue your current compounded medication?
- Format: Radio Button
- **Conditions: I agree
I DO NOT agree**

**Q16.1** You selected that you  DO NOT agree to continue your current compounded medication. Is this correct?
- Format: Radio Button
- Answers: If #16 = I DO NOT agree, DISPLAY

If # 16.1 = Yes, DISQUALIFIED
- **Conditions: Yes 
No**
- Popup: You selected that you do not wish to continue your current compounded medication. This means we will not be able to continue your treatment moving forward. Would you like to cancel your subscription?

[ Cancel Subscription ]     [ Go Back ]
- Notes: loc::ghk-cu-injection-initial-intake-9

**Q17.0** Would you like to continue using a multidose vial to allow for dosing flexibility?
- Format: Radio Button
- **Conditions: I agree
I DO NOT agree**

**Q17.1** You selected that you would like to discontinue using a multidose vial for dosing flexibility. Is this correct?
- Format: Radio Button
- Answers: If #17 = I DO NOT agree, DISPLAY

If # 17.1 = Yes, DISQUALIFIED
- **Conditions: Yes 
No**
- Popup: You selected that you do not wish to continue using a multidose vial for dosing flexibility. This means we will not be able to continue your treatment moving forward. Would you like to cancel your subscription?

[Cancel Subscription]     [ Go Back ]

**Q18.0** How would you like to continue your treatment?

Next, lets select the specific Tier you would prefer to move forward with: 

** Please note, final Tier and approval will be the your providers descretion.

**Q20.0** Anything we missed? Message your doctor! Please give an update, and feel free to:
...
- Format: Text Box
- **Conditions: Example: Everything is going well so far and I'm happy with my treatment.**

**Q21.0** Please provide a current, FULL body photo of yourself wearing form-fitting clothing while...
...
Supported file types: 
JPG, PNG, PDF, HEIC
- Notes: Form of Identification Questionnaire

**Q22.0** Understanding GLP-1 Medications
...
- **Conditions: Digital Signature: (First and Last Name)
Date: [Auto-filled]
**
...
Retinopathy
- Format: Radio Button
- **Conditions: YES, I CONSENT to being treated with sublingual (under-the-tongue) GLP-1 agonists. I want to avoid needles and injections. I have reviewed the risks and benefits above.
...
Date: [Auto-filled]
**
- Notes: Consent to Treatment Via Telehealth Questionnaire

**Q23.0** A valid photo identification such as driver’s license or passport is required to receive a prescription. You will receive your product faster if you upload your ID now. However, you can skip this step and receive an email after payment requesting your ID.
- Format: Photo Upload
- Answers: Max File Size: 5MB
...
- Format: Check Box 
(Multi Select) 
- Answers: If  "Benzyl Alcohol Allergy" , DISQUALIFIED
- **Conditions:  ☐ A Personal or Family History of Medullary Thyroid Carcinoma (MTC) (a type of thyroid cancer)
 ☐ Multiple Endocrine Neoplasia Type 2 (MEN 2) (tumors in your glands)
 ☐ Hypersensitivity Reaction to GLP-1
 ☐ History of Type 1 Diabetes
 ☐ Chronic pancreatitis or previous episode of pancreatitis due t**
- Popup: Unfortunately, we cannot proceed with prescribing this medication if you have any allergy to benzyl alcohol. We recommend speaking with your primary care specialist to discuss alternative therapies and options.

Do any of the following comorbidities or medical conditions apply to you?
- Format: Check Box 
(Multi Select) 
