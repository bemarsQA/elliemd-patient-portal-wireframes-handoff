...
- Format: Photo Upload
- **Conditions: If #9 = orange or red questions, DISPLAY
...
- Format: Text Box
- **Conditions: If #9.2.6 = Date > 30 days from todays date, DISPLAY**

**Q10.8** Please tell the doctor more about your severe GI problems
- Format: Text Box
...
**Q10.9** Are you sure it is medullary thyroid cancer?
- Format: Text Box
...
**Q11.0** Are you sure you have Type 1 Diabetes?
- Format: Check Box 
(Single Select)
...
**Q11.1** Does anyone in your family have a history of...
- Format: Check Box 
(Multi Select)
...
**Q11.2** Does anyone in your family have a history of...
- Format: Check Box 
(Multi Select)
- Answers:  ☐ MEN2 (multiple endocrine neoplasia syndrome type 2)
 ☐ Medullary thyroid cancer
...
**Q11.4** Please tell the doctor...
- Format: Text Box
- Answers: "Ex: 1) Sphincter of Oddi dysfunction 2) I still have my gallbladder"

**Q11.5** Please describe what type of liver disease/cirrhosis you have been diagnosed with:
- Format: Text Box
- Answers: "Ex: alcoholic liver cirrhosis"
- **Conditions: if #9 = Liver disease/cirrhosis, DISPLAY**

**Q11.6** Does anyone in your family have a history of...
- Format: Check Box 
(Multi Select) 
- Answers:  ☐ MEN2 (multiple endocrine neoplasia syndrome type 2)
 ☐ Medullary thyroid cancer
...
**Q11.7** Are you sure your family member has medullary thyroid cancer?
- Format: Text Box
...
Month 1: 8.0 mg/week
Month 2: 9.0 mg/week
Month 3: 10.0 mg/week

Tier 3 – $499
Month 1: 12.5 mg/week
Month 2: 12.5 mg/week
Month
- **Conditions: If #9 = orange or red questions, DISPLAY**

**Q12.0** Have you discussed GLP-1/GIP+B12 Injection Treatment options with your primary care doctor?
- Format: Radio Button
- Answers: Yes 
No
- **Conditions: If Yes or No, Show Pop Up Text**
- Popup: We encourage you to discuss GLP-1/GIP+B12 Injection treatment with your primary care provider, as they have a more complete understanding of your health history. EllieMD provides this service based on the information you share and does not replace in-person medical care or long-term health managemen
...
**Q33.0** A valid photo identification such as driver’s license or passport is required to receive a prescription. You will receive your product faster if you upload your ID now. However, you can skip this step and receive an email after payment requesting your ID.
- Format: Photo Upload
- **Conditions: Skip option
