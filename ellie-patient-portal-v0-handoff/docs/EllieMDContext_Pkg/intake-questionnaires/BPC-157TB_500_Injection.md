...
**Q13.0** Do you have any know allergies to benzyl alcohol?
- Format: Radio Button
- Answers: Yes
No
...
**Q16.0** Do you have any active infections or illness?
- Answers: Yes 
No
...
**Q17.0** Have you ever been diagnosed with any chronic medical conditions? (e.g., diabetes, thyroid disease, autoimmune disorders, heart or circulation problems, blood clots, kidney or liver disease)
- Format: Radio Button
- Answers: Yes 
No

**Q17.1** Please list all chronic medical conditions you have been diagnosed with, whether current or past.
- Format: Text Box
- **Conditions: If #17 = Yes, DISPLAY**
- Notes: Patient Profile 
Conditions

**Q18.0** Have you ever been diagnosed with cancer or tumors (inlcuding past cancers that are no longer under treatment or surveillance)?
- Format: Radio Button
- Answers: Yes 
No

**Q18.1** Are you currently undergoing chemotherapy or radiation therapy treatment for your cancer?
- Format: Radio Button
- Answers: Yes 
No
- **Conditions: If #18 = Yes, DISPLAY 18.1
If #18.1 = Yes, DISQUALIFIED**
...
**Q18.2** Was the diagnosis limited to fully excised basal cell carcinoma or squamous cell carcinoma of the skin with no recurrence or ongoing treatment?
- Format: Radio Button
- Answers: Yes
No
- **Conditions: If #18 = Yes, DISPLAY 18.2**

**Q18.3** Please specify the type, year of diagnosis, treatment received, and current status (active, remission, cured).
- Format: Text Box
- **Conditions: If #18 = Yes, DISPLAY 18.3**

**Q18.4** Approximately how long ago did you complete cancer treatment?
- Format: Radio Button
- Answers: Within the last 2 years
2-5 years ago
More than 5 years ago
- **Conditions: If #18.2 = No, DISPLAY 18.4
If #18.4 = Within the last 2 years, DISQUALIFIED
If #18.4 = 2-5 years ago, DISPLAY
If #18.4 = More than 5 years ago, DISPLAY**
...
**Q21.0** A valid photo identification such as driver’s license or passport is required to receive a prescription. You will receive your product faster if you upload your ID now. However, you can skip this step and receive an email after payment requesting your ID.
- Format: Photo Upload
