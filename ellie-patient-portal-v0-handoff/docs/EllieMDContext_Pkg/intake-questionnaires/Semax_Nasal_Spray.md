...
**Q4.0** What are the primary reasons for considering Semax Nasal Spray?
- Format: Check Box 
(Multi Select) 
- Answers: ☐ Focus or concentration
☐ Brain fog or mental clarity
☐ Mental performance and productivity
☐ Memory and learning support
☐ Sustained mental energy and endurance
☐ Inflammation support

**Q5.0** Have you ever had an allergic or hypersensitivity reaction to Semax or any formulation components?
- Format: Radio Button
- Answers: Yes
No
Not sure
- **Conditions: If #5 = Yes, DISQUALIFIED**
- Popup: Unfortunately, we cannot proceed with prescribing this medication if you have a known hypersensitivity or allergy to Semax or any formulation components. We recommend consulting your primary care provider to explore alternative therapies and options.
