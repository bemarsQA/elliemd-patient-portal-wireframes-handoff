...
**Q7.0** What is the primary reason for seeking The Thrill PIll therapy?
- Format: Check Box 
(Multi Select) 
- Answers:  ☐ Enhance Intimacy or Sexual Connection
 ☐ Low Libido/Decreased Sexual Desire
 ☐ Difficulty with Arousal or Orgasm
 ☐ Performance Anxiety or Psychological Barriers to Intimacy 
 ☐ Mood or Emotional Bonding Enhancement

**Q8.0** Do you have any allergies or known adverse reactions to peptides, oxytocin, or PDE5 inhibitors (like tadalafil or sildenafil)?
- Format: Radio Button
- Answers: Yes 
No
- **Conditions: If Yes, DISQUALIFIED**
...
**Q9.0** Have you discussed The Thrill Pill treatment options with your primary care doctor?
- Format: Radio Button
- Answers: Yes 
No
- **Conditions: If Yes or No, Show Pop Up Text**
- Popup: We encourage you to discuss The Thrill Pill treatment with your primary care provider, as they have a more complete understanding of your health history. EllieMD provides this service based on the information you share and does not replace in-person medical care or long-term health management.
...
**Q15.0** Have you ever been diagnosed with any of the following?
- Format: Check Box 
(Multi Select) 
- Answers:  ☐ Cardiovascular disease or heart condition
 ☐ Uncontrolled hypertension (high blood pressure)
 ☐ Low blood pressure or fainting episodes
 ☐ Stroke or TIA (mini stroke)
 ☐ Eye disorders related to blood flow (e.g., NAION)
 ☐ Liver or kidney disease
 ☐ Mental health disorders (e.g., bipolar disorder

**Q16.0** Are you currently taking any medications that may interact with tadalafil, PT-141, or oxytocin? (e.g., nitrates, alpha-blockers, antidepressants, antipsychotics, or blood pressure medications)
- Format: Radio Button
- Answers: Yes 
No

**Q16.1** Please list all current medications and therapies you are using.
- Format: Text Box
- **Conditions: If #16 = Yes, DISPLAY**

**Q17.0** Have you ever been diagnosed with cancer or tumors?
- Format: Radio Button
- Answers: Yes 
No

**Q17.1** Please specify the type and your treatment history:
- Format: Text Box
- **Conditions: If #17 = Yes, DISPLAY**
- Notes: Patient Profile 
Conditions

**Q17.2** Are you currently undergoing chemotherapy or radiation therapy treatment for your cancer?
- Format: Radio Button
- Answers: Yes 
No
- **Conditions: If Yes, DISQUALIFIED**
