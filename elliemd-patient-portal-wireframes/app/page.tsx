    ...
    <WireframeChrome>
      <div>
        <main className="py-10 lg:py-12">
          ...
          <h1 className="font-serif text-2xl font-bold tracking-tight text-[#141B34] md:text-3xl">
          ...
          <section className="mt-10" aria-labelledby="today-proposed-heading">
            <h2
          ...
          <section className="mt-10" aria-labelledby="scope-heading">
            <h2
              id="scope-heading"
              className="text-base font-semibold text-[#141B34]"
            >
              Scope
            </h2>
          ...
          <section className="mt-10" aria-labelledby="proposals-heading">
            <h2
              ...
              className="inline-flex items-center gap-2 text-base font-semibold text-[#141B34]"
            >
              Design Proposals{" "}
          ...
          <div className="mt-12 flex flex-col items-center gap-4 border-t border-neutral-200 pt-8">
            <Link
