...
import { ReviewViewportToggle } from "@/components/ReviewViewportToggle";
...
const DECISIONS = [
  ...
  <>
    <strong>Next renewal</strong> or <strong>next charge</strong> always
    includes amount and date; <strong>shipment</strong> timing lives under
    fulfillment when both are shown.
  </>,
  <>
        ...
        <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
          <ReviewViewportToggle>
            ...
            <p className="mt-4 max-w-3xl text-base leading-relaxed text-neutral-600">
              After purchase, patients should see the same subscription story
              they saw at checkout and on the PDP: true cycle price, clear
              billing cadence, and honest renewal expectations. Today the portal
              often blurs shorthand display pricing with real cycle charges,
              hides when the next bill hits, and uses shipment language where
              billing should lead. Terminology drifts from checkout and PDP, so
              patients cannot trust the numbers they see. These wireframes
              tighten that experience so renewals feel predictable and support
              tickets go down.
            </p>

            <section className="mt-12" aria-labelledby="page-map-heading">
              <h2
                id="page-map-heading"
              ...
              <p className="mt-2 max-w-2xl text-sm text-neutral-600">
                Five wireframe sections plus this overview. Everything needed to
                review the remit lives in-site; the{" "}
                <Link
                ...
                page holds decision traceability, proposals, APIs, and
                terminology.
              </p>
              <ul className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <li className="rounded-lg border border-neutral-200 bg-white p-3 text-sm shadow-sm">
                  <Link
                    className="font-semibold text-[#141B34] underline decoration-neutral-300 underline-offset-2 hover:decoration-[#141B34]"
                    href="/"
                  >
                    Overview
                  </Link>
                  <p className="mt-1 text-xs text-neutral-600">
                    Today vs proposed, scope, examples, journey, decisions,
                    proposals.
                  </p>
                </li>
                <li className="rounded-lg border border-neutral-200 bg-white p-3 text-sm shadow-sm">
                  ...
                  <p className="mt-1 text-xs text-neutral-600">
                    Step 3: Current vs Proposed, toggles, annotations,
                    acceptance.
                  </p>
                </li>
                <li className="rounded-lg border border-neutral-200 bg-white p-3 text-sm shadow-sm">
                  ...
                  <p className="mt-1 text-xs text-neutral-600">
                    Step 4: order / subscription detail, delta table,
                    acceptance.
                  </p>
                </li>
                <li className="rounded-lg border border-neutral-200 bg-white p-3 text-sm shadow-sm">
                  ...
                  <p className="mt-1 text-xs text-neutral-600">
                    Step 5: empty, paused, payment, tiers, composite cycles, and
                    more.
                  </p>
                </li>
                <li className="rounded-lg border border-neutral-200 bg-white p-3 text-sm shadow-sm">
                  ...
                  <p className="mt-1 text-xs text-neutral-600">
                    Traceability (green), proposals (orange), APIs, terminology.
                  </p>
                </li>
              </ul>
            </section>
            ...
            <section className="mt-12" aria-labelledby="today-proposed-heading">
              <h2 id="today-proposed-heading" className="sr-only">
              ...
              <div className="grid gap-6 lg:grid-cols-2">
                <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-neutral-800">
                    Patients cannot see <strong>subscription billing</strong>{" "}
                    clearly: billing cadence (
                    <code className="rounded bg-neutral-100 px-1 text-xs">
                      orderCycle
                    </code>
                    ) is often missing, pricing mixes{" "}
                    <strong>per month / retail</strong> with true cycle charges,
                    and <strong>“Next shipment”</strong> appears where{" "}
                    <strong>next charge / renewal</strong> should set
                    expectations. <strong>Current Payment Plan</strong> and{" "}
                    <strong>1st / 2nd / 3rd Payment</strong> read like
                    financing, not per-cycle renewals.
                  </p>
                </div>
                <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-neutral-800">
                    ...
                    <strong>orderCycle</strong> into portal surfaces the same
                    way as checkout. <strong>Per cycle</strong> language
                    replaces confusing simplified-interval framing where it
                    misleads. <strong>Per-day</strong> stays secondary. Every
                    subscription view shows <strong>next charge</strong> (amount
                    + date). Use <strong>prescriptionCycle</strong> only for
                    script/refill context, not as a substitute for billing
                    cadence. Keep <strong>fulfillment</strong> (ship/tracking)
                    separate from <strong>billing</strong> when both appear.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="mt-4 space-y-3">
                <div className="flex flex-col gap-3 rounded-xl border border-neutral-200 bg-neutral-50/90 p-4 sm:flex-row sm:items-start">
                  ...
                  <p className="text-sm leading-relaxed text-neutral-800">
                    Subscription list, order detail, and edge-state screens
                    anywhere cadence and cycle price appear. Terminology matches
                    checkout:{" "}
                    ...
                    , per-cycle hero pricing, next charge called out. Two
                    example products (8-week and 12-week cycles) anchor the
                    review decks.
                  </p>
                </div>
                <div className="flex flex-col gap-3 rounded-xl border border-neutral-200 bg-neutral-50/90 p-4 sm:flex-row sm:items-start">
                  ...
                  <p className="text-sm leading-relaxed text-neutral-800">
                    Full PDP or checkout redesign (separate deliverables).
                    Payment processor integration details. Ellie Payment Plan /
                    BNPL product spec unless explicitly approved. Admin or
                    internal tooling.
                  </p>
                </div>
              </div>
            ...
            <section className="mt-12" aria-labelledby="journey-heading">
              ...
              <p className="mt-2 max-w-2xl text-sm text-neutral-600">
                Same narrative as checkout: see what you pay per cycle, drill
                into the order, then handle exceptions without losing the
                billing story.
              </p>
              <ol className="mt-8 flex flex-col gap-8 sm:flex-row sm:flex-wrap sm:justify-between sm:gap-6 lg:gap-8">
                ...
                <li className="flex max-w-[14rem] flex-1 flex-col items-center text-center">
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-neutral-600">
                    Totals and payment schedule aligned to the billed cycle, not
                    a misleading uniform-period story
                  </p>
                </li>
                <li className="flex max-w-[14rem] flex-1 flex-col items-center text-center">
                  <span
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-neutral-600">
                    Reassessment pending, paused, failed payment, composite
                    cycles
                  </p>
                </li>
              </ol>
            ...
            <section className="mt-14" aria-labelledby="decisions-heading">
              ...
              <p className="mt-2 text-xs text-neutral-600">
                Locked product and engineering choices that keep portal copy
                honest and consistent with checkout. Policy changes still need
                the usual sign-off.
              </p>
            ...
            <section
              className="mt-12 rounded-2xl border border-emerald-200 bg-emerald-50/40 p-6"
              aria-labelledby="overview-acceptance-heading"
            >
              <h2
                id="overview-acceptance-heading"
              ...
              <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-relaxed text-neutral-800">
                <li>
                  Page map links to every wireframe route; Sources is one click
                  away for traceability.
                </li>
                <li>
                  Today vs proposed clearly separates legacy patterns from the
                  target billing story (cycle price, cadence, next charge).
                </li>
                <li>
                  Both cadence examples (8-week NAD+ and 12-week Semaglutide
                  Tier 1) show{" "}
                  <code className="rounded bg-white px-1 text-xs">
                    orderPrice
                  </code>
                  ...
                  , per-day secondary, and next charge context.
                </li>
                <li>
                  Decisions are marked locked; design proposals are marked
                  pending; device preview supports desktop and ~390px QA.
                </li>
              </ul>
            </section>
