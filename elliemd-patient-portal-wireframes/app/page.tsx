      ...
      <div className="bg-white">
        <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8 lg:py-12">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-neutral-600">
            Ensure post-purchase screens show the same billing story as
            checkout: cycle price, cadence, and next charge. These wireframes
            tighten that alignment and remove misleading billing copy.
          </p>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-4 text-sm leading-relaxed text-neutral-800">
                  ...
                  <strong>1st / 2nd / 3rd Payment</strong> read like financing,
                  not per-cycle renewals.
                </p>
              </div>
              <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-4 text-sm leading-relaxed text-neutral-800">
                  ...
                  <strong>orderCycle</strong> into portal surfaces the same way
                  as checkout. <strong>Per cycle</strong> language replaces
                  confusing simplified-interval framing where it misleads.{" "}
                  <strong>Per-day</strong> stays secondary. Every subscription
                  view shows <strong>next charge</strong> (amount + date). Use{" "}
                  <strong>prescriptionCycle</strong> only for script/refill
                  context, not as a substitute for billing cadence. Keep{" "}
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="flex flex-col gap-3 rounded-xl border border-neutral-200 bg-neutral-50/90 p-4 sm:flex-row sm:items-start">
                ...
                <p className="text-sm leading-relaxed text-neutral-800">
                  ...
                  processor integration details. Ellie Payment Plan / BNPL
                  product spec unless explicitly approved. Admin or internal
                  tooling.
                </p>
              </div>
            </div>
          ...
          <section className="mt-12" aria-labelledby="journey-heading">
            ...
            <p className="mt-2 max-w-2xl text-sm text-neutral-600">
              Same narrative as checkout: see what you pay per cycle, drill into
              the order, then handle exceptions without losing the billing
              story.
            </p>
            <ol className="mt-8 flex flex-col gap-8 sm:flex-row sm:flex-wrap sm:justify-between sm:gap-6 lg:gap-8">
              ...
              <li className="flex max-w-[14rem] flex-1 flex-col items-center text-center">
                ...
                <p className="mt-1 text-xs leading-relaxed text-neutral-600">
                  ...
                  misleading uniform-period story
                </p>
              </li>
              <li className="flex max-w-[14rem] flex-1 flex-col items-center text-center">
                <span
          ...
          <section className="mt-14" aria-labelledby="decisions-heading">
            ...
            <p className="mt-2 text-xs text-neutral-600">
              ...
              honest and consistent with checkout. Policy changes still need the
              usual sign-off.
            </p>
