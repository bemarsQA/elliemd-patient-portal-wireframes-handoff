      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <ReviewViewportToggle>
          ...
          <p className="mt-2 max-w-3xl text-neutral-600">
            ...
            <strong>Patient Portal v2 Figma frames</strong>. Green = traceable
            to{" "}
            <code className="rounded bg-neutral-200 px-1 text-xs">data/</code>{" "}
            (or intake docs where noted). Orange = proposals. Engineering
                ...
                <tbody className="divide-y divide-emerald-100 bg-white/60">
                  <tr>
                    ...
                    <td className="p-3 text-neutral-700">
                      Authoritative price table; portal should not invent
                      amounts
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td className="p-3">
                      Next shipment vs billing expectation
                    </td>
                    <td className="p-3 font-mono text-xs">
                      Patient Portal v2 Figma frames §B, §J
                    </td>
                    <td className="p-3 text-xs text-neutral-700">
                      Figma section refs §B (home), §J (example product); not a
                      product-pricing row
                    </td>
                    <td className="p-3 text-neutral-700">
                ...
                <tbody className="divide-y divide-orange-100 bg-white/60">
                  ...
                  <tr>
                    ...
                    <td className="p-3 text-xs">
                      Patient Portal v2 Figma frames §E
                    </td>
                    <td className="p-3 text-xs text-neutral-700">
          ...
          <section className="mt-10 overflow-x-auto rounded-xl border border-sky-200 bg-sky-50/40 p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm text-neutral-700">
              ...
              in the stakeholder package. Use this table for Step 7 price
              audits.
            </p>
          ...
          <section className="mt-10 overflow-x-auto rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 rounded-lg border border-amber-200 bg-amber-50/60 p-4 text-sm leading-relaxed text-neutral-800">
              ...
              <p className="mt-2">
                ...
                <strong>Resume subscription</strong>) against the stakeholder
                deck before sign-off. The table above is the data anchor for
                money and cadence fields; Section 13 is the UX/copy lock for
                visible controls.
              </p>
              <p className="mt-2 text-xs text-neutral-600">
                Legacy or forbidden phrasing may appear only in strikethrough
                rows or in wireframe <strong>Current</strong> panels—not as the
          ...
          <section
            ...
            aria-labelledby="sources-acceptance-heading"
          >
            <h2
              id="sources-acceptance-heading"
            ...
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-relaxed text-neutral-800">
              <li>
                Decision traceability and design proposals are in separate
                color-coded tables with document paths and location/anchor
                columns.
              </li>
              <li>
                SKU verification lists every example product used in wireframes
                plus composite-cycle reference rows, with amounts matching{" "}
                <code className="rounded bg-white px-1 text-xs">
                  product-pricing
                </code>
                .
              ...
              <li>
                Engineering touchpoints name illustrative endpoints and the
                fields they should expose.
              </li>
              <li>
                Terminology alignment plus Section 13 note document data locks
                vs control-label locks; device preview supports desktop and
                ~390px QA.
              </li>
            </ul>
          </section>
