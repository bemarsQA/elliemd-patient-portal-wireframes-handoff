      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <ReviewViewportToggle>
          ...
          <div className="mt-6 space-y-6">
            ...
            >
              <p>
                Patient Portal v2 Figma frames §F:{" "}
                <strong>Price pending reassessment results</strong> on scheduled
                rows. Proposed: show scheduled date, status badge, and
                explainer; hide misleading dollar amount until{" "}
                <EngTag>orderPrice</EngTag> confirmed.
              </p>
            </Panel>
            ...
            >
              <p>
                ...
                with <strong>description</strong> (“8 week supply, 2 week
                break”). Product copy may also appear in{" "}
                <code className="rounded bg-neutral-200 px-1 text-xs">
            ...
            >
              <p>
                Patient Portal v2 Figma frames §B, §J: subscription cards show{" "}
                <strong>Next shipment</strong> without{" "}
                <strong>next charge</strong>. Proposed: always pair billing
                line; shipment only under fulfillment. Annotate in QA when
                legacy copy appears.
              </p>
            </Panel>
            ...
            >
              <p>
                ...
                (Patient Portal v2 Figma frames §E; compare tier rules in{" "}
                <code className="rounded bg-neutral-200 px-1 text-xs">
            ...
            >
              <p>
                ...
                frames: “Pending Provider Approval”). Show status badge,
                expected first billing date when known, and that{" "}
            ...
            >
              <p>
                SKUs that are not prescription subscriptions (example: a
                recurring supplement billed outside the prescription
                subscription pattern) should not reuse subscription renewal
                components. Use a distinct card pattern: one-time or different
                billing label, no false
                <EngTag>orderCycle</EngTag> language unless truly on a
                subscription backend. Call out in QA when PDP and portal
                disagree.
              </p>
            </Panel>
          </div>
          ...
          >
            ...
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-relaxed text-neutral-800">
              <li>
                ...
                where relevant), and traceability (Figma,{" "}
                <code className="rounded bg-white px-1 text-xs">data/</code>, or
                intake).
              </li>
              <li>
                Composite-cycle examples preserve supply/break descriptions; QA
                does not simplify to a misleading cadence label.
              </li>
              <li>
                Anti-patterns (next shipment for billing, financing vs renewal)
                are labeled and paired with proposed handling.
              </li>
              <li>
                Device preview supports desktop and ~390px review consistent
                with Step 3 / Step 4 wireframes.
              </li>
            </ul>
          </section>
        </ReviewViewportToggle>
