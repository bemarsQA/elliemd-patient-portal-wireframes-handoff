  ...
  return (
    <main className="py-8">
      ...
      <p className="mt-2 max-w-3xl text-neutral-600">
        ...
        ); copy gaps vs <strong>Patient Portal v2 Figma frames</strong>.
      </p>
          ...
          <div className={wfControlColumn}>
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-1">
              ...
              <button
                ...
                className={
                  listMode === "multiple" ? wfToggle.active : wfToggle.inactive
                }
              >
                Multiple (2–3)
              </button>
        ...
        <table className="w-full min-w-[640px] text-left text-sm">
          ...
          <tbody className="divide-y divide-neutral-100">
            <tr>
              ...
              <td className="p-3">
                Matches PDP &amp; checkout; removes billing-cycle vs
                display-window confusion
              </td>
            ...
            <tr>
              ...
              <td className="p-3">
                Prominent <EngTag>orderPrice</EngTag> replaces retail-interval
                hero
              </td>
              <td className="p-3">Patient sees actual renewal charge amount</td>
              <td className="p-3 text-xs">data/product-pricing.md</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="p-3">
                Explicit date + amount; not “next shipment”
              </td>
      ...
      <div className="mt-8 rounded-xl border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        <ul className="mt-4 space-y-2 text-sm text-neutral-700">
          ...
          <li className="flex gap-2">
            ...
            for amounts/cadence; portal copy aligned with Patient Portal v2
            Figma frames.
          </li>
        </ul>
      </div>
